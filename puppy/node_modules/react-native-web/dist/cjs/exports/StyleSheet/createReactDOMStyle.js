...
var createReducer = function createReducer(style, styleProps) {
  ...
  return function (resolvedStyle, prop) {
    var value = (0, _normalizeValue.default)(prop, style[prop]); // Normalize color values
      ...
      case 'fontFamily':
        {
          if (value.indexOf('System') > -1) {
            ...
            stack[stack.indexOf('System')] = _constants.systemFontStack;
            resolvedStyle.fontFamily = stack.join(', ');
          } else if (value === 'monospace') {
            resolvedStyle.fontFamily = _constants.monospaceFontStack;
          } else {
