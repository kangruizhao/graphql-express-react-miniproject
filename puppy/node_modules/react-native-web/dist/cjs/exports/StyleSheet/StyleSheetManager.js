...
var createClassName = function createClassName(name, value) {
  var hashed = (0, _hash.default)(name + normalizeValue(value));
...
function () {
  ...
  _proto.injectRule = function injectRule(name, body) {
    var className = createClassName("ui-" + name, body);
    var rule = "." + className + "{" + body + "}"; // insert after the reset + modality but before atomic css
